...
//		populateMap();
	...
	private static void populateMap() {
		employeesMap.put(1, new PartTime("Ankur", LocalDate.parse("2023-08-02"), "8600386608", "471616721623", 200));
		employeesMap.put(2, new FullTime("Darshan", LocalDate.parse("2023-07-01"), "1000386608", "471616721612", 20000));
		employeesMap.put(3, new PartTime("Yashraj", LocalDate.parse("2023-04-23"), "842386608", "471616721613", 100));
		employeesMap.put(4, new FullTime("Pratham", LocalDate.parse("2023-08-02"), "1286086608", "471616721212", 40000));
		employeesMap.put(5, new FullTime("Soham", LocalDate.parse("2021-07-02"), "2340386608", "471616712623", 80000));
	}
